...
import { faHome,faFile ,faBell, faUpload, faCogs } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <>
      <Nav className="me-auto d-flex align-items-center navbar-links">
       ...
       <Nav.Link as={Link} to="/file" className={`d-flex align-items-center ${location.pathname === '/file' ? 'active' : ''}`}>
